...
imgStack = stackImages(0.2,[img,img,img])  #缩小的倍数，一行三张图片

imgStack2 = stackImages(0.2,([img,img,img],[img,img,img],[img,img,img]))  #三行三列一样的图片
#加入灰度图像
imgStack3 = stackImages(0.2,([img,imgGray,img],[img,img,img]))
